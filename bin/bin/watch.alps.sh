...
watch -n 3.0 "qstat --header=JobID:JobName:User:WallTime:QueuedTime:RunTime:TimeRemaining:Nodes:State:Queue:Score --sort State:Score:Queue:JobID --reverse -u ${USER} ;"
