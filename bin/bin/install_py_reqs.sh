...
LOG_DIR=${HOME}/public_html/build_logs/pip.$(date +%F_%H%M)
mkdir -p ${LOG_DIR}
...
python3 -m pip install --user --ignore-installed --upgrade -r ${GEOPM_SOURCE}/integration/requirements.txt >> ${LOG_DIR}/pip.log 2>&1
